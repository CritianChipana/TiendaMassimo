...
include_once("../Modelo/EntidadFactura.php");
    ...
    class formVisualizarReporteFactura
    {
               ...
               <html lang="en" >
                ...
                <body>
                    ...
                    <nav class="navbar navbar-light bg-light">
                        ...
                        <div class="container-fluid">
                            <h3> Cantidad de facturas:  &nbsp<?php echo$resultado->num_rows; ?></h3>
                        </div>
                        <div class="container-fluid">
                            <h4> Facturas emitidas entre : <?php echo $fechaInicio; ?>&nbsp  y &nbsp<?php echo $fechaFinal; ?></h4>
                        </div>
                    </nav>
                    ...
                    <?php 
                        ...
                        {?>
                            ...
                            <td style="text-align: center;"><?php echo ($filaEncontrada[$i]['ruc']) ?></td>
